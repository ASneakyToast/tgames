...
/* Some crazy code (flyweight) v cool not sure how to framework it up
class TileCreator {
  constructor() {
    this.tiles = {};
  }
  create(x, y) {
    ...
    this.tiles[value] = new Tile(x, y, value);
...
class Board {
  ...
  /* yeah this shoild be a game command not a class method
  getSafeSpawn() {
    let spawnable = [];
